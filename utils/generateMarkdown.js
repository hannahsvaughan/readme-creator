...
function renderLicenseBadge(license) {
  ...
  for (i = 0; i < licensesDetails.length; i++) {
    if (license.toLowerCase() == licensesDetails[i].name.toLowerCase()) {
      console.log(license, licensesDetails[i].name)
      console.log(licensesDetails[i].badge)
      return licensesDetails[i].badge;
    }
  }
}
